...
import aboutImage from '../assets/1-434.jpg';
      ...
      <section id="services">
        ...
        <div className="services-container">
          <div className="service-card">
            <img src={aboutImage} alt="Service 1"/>
            <h3>Get Started</h3>
            <p>Lorem ipsum dolor sit amet.</p>
            <Link to="/login" className="button-link">Explore &gt;</Link>
          </div>
          <div className="service-card">
            <img src={aboutImage} alt="Service 2"/>
            <h3>Hire a model</h3>
            <p>Lorem ipsum dolor sit amet.</p>
            <Link to="/signup">Sign up &gt;</Link>
          </div>
          <div className="service-card">
            <img src={aboutImage} alt="Service 3"/>
            <h3>Hire a model</h3>
            <p>Lorem ipsum dolor sit amet.</p>
            <Link to="/signup">Sign up &gt;</Link>
          </div>
        ...
        <div className="pricing-container">
          ...
          <div className="pricing-plans">
            ...
            <div className="pricing-plan">
              ...
              <p>Ideal for fitness enthusiasts & wellness seekers</p>
            ...
            <div className="pricing-plan">
              ...
              <p className="price">N 60,500 <span>/month</span></p>
              <p>For dedicated wellness enthusiasts</p>
              <ul className="plan-features">
            ...
            <div className="pricing-plan">
              ...
              <p className="price">N 60,500 <span>/month</span></p>
              <p>For those seeking a comprehensive wellness experience</p>
              <ul className="plan-features">
